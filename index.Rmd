...
The most intriguing segment of the song that can be visually observed lies between 180s to 235s, where the vocals fade out and a electronic synthesizer or electric guitar enters the scene and the bass drum fades slightly, carrying a more melodic fill which create an air of dreaminess. The synthesizer subsequently fades out, and the bass drums dominance is then reflected in the clear 140 bpm reflected for the rest of the song. As a slow paced and calm individual, this song encapsulates Megan's pleasant and gentle demeanor, one that also reflects her as a thoughtful individual. 
